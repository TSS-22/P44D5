...
class MidiControllerSettings:
    def __init__(self, midi_config_settings):
        ...
        self.pad_mode = midi_config_settings["pad_mode"]
        self.base_note_offset = midi_config_settings["base_note_offset"]
        self.id_knob_mode = midi_config_settings["id_knob_mode"]
        self.id_knob_chord_comp = midi_config_settings["id_knob_chord_comp"]
        self.id_knob_chord_size = midi_config_settings["id_knob_chord_size"]
        self.id_knob_base_note = midi_config_settings["id_knob_base_note"]
        self.id_knob_key_note = midi_config_settings["id_knob_key_note"]

        # Most likely will need to put that into a function to allow for user to change the settings.
        self.pot_max_value = (
            midi_config_settings["pot_max_value"] + 1
